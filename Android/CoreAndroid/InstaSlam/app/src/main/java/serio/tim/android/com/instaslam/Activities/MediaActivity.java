...
import serio.tim.android.com.instaslam.Model.InstaImage;
...
public class MediaActivity extends AppCompatActivity {
    ...
    class DecodeBitmap extends AsyncTask<Void, Void, Bitmap> {
        private final WeakReference<ImageView> mImageWeakReference;
        private InstaImage image;

        public DecodeBitmap(ImageView imageView, InstaImage image) {
            this.mImageWeakReference = new WeakReference<ImageView>(imageView);
            this.image = image;
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            final ImageView img = mImageWeakReference.get();
            if(img != null) {
